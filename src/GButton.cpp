...
String GButton::gd_getTitle() { return GObject::toGodotStr(getTitle()); }
void GButton::gd_setSelectedTitle(const String& value) { setSelectedTitle(value.utf8().get_data()); }
String GButton::gd_getSelectedTitle() const { return GObject::toGodotStr(getSelectedTitle()); }
void GButton::gd_setIcon(const String& value) { setIcon(value.utf8().get_data()); }
String GButton::gd_getIcon() const { return GObject::toGodotStr(getIcon()); }
