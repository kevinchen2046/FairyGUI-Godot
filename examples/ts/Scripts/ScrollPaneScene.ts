    ...
    protected ContinueInit(): void {
        ...
        if (this._list != null) {
            ...
            this._list.addEventListener(
                ...
                Callable.create(this._onClickList.bind(this)),
            );
        }
    }
    ...
    private _onClickList(): void {
        ...
        for (let i = 0; i < cnt; i++) {
            ...
            if (sp != null && sp.getPosX() !== 0) {
                ...
                const b0 = item.getChild("b0") as GComponent | null;
                const b1 = item.getChild("b1") as GComponent | null;
                if (
                    touchTarget != null &&
